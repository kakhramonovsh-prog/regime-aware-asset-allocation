...
that survived a search. Prospective specification, frozen data, causal tests,
...
strategy under a prospectively specified design with a matched comparator, which
...
charged on realized turnover --- and fixes the comparison before
...
Specifying a single primary comparison in advance and applying Holm adjustment
