...
not alter the prespecified hypothesis, which concerns the regime rung.

\input{tables/table1_performance.tex}

\subsection{The prespecified comparison}
...
\input{tables/table2_primary_inference.tex}
...
\nSignReversals{} of the prespecified variations: the three-state HMM
...
\input{tables/table4_robustness_grid.tex}
...
\paragraph{Researcher discretion.} Prospective specification, frozen data, causal
